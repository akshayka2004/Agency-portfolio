    ...
    <div className="min-h-screen bg-white text-[#0F172A] selection:bg-accent/10 selection:text-accent overflow-x-hidden">
      <main className="w-full">
        ...
        <section className="min-h-[80vh] flex flex-col items-center justify-center bg-[#F8FAFC] border-y border-border/20 py-20">
          <div className="w-full max-w-[1100px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <motion.div variants={fadeInItem} className="bg-white p-8 rounded-2xl shadow-lg border border-border/30">
                <h4 className="text-lg font-bold mb-2 text-[#0F172A]">Speed</h4>
                <p className="text-[#64748B] text-sm font-medium">Weeks, not months.</p>
              </motion.div>
              <motion.div variants={fadeInItem} className="bg-white p-8 rounded-2xl shadow-lg border border-border/30">
                <h4 className="text-lg font-bold mb-2 text-[#0F172A]">Direct</h4>
                <p className="text-[#64748B] text-sm font-medium">Founder to engineer.</p>
              </motion.div>
              <motion.div variants={fadeInItem} className="bg-white p-8 rounded-2xl shadow-lg border border-border/30">
                <h4 className="text-lg font-bold mb-2 text-[#0F172A]">Scale</h4>
                <p className="text-[#64748B] text-sm font-medium">Institutional depth.</p>
              </motion.div>
              <motion.div variants={fadeInItem} className="bg-white p-8 rounded-2xl shadow-lg border border-border/30">
                <h4 className="text-lg font-bold mb-2 text-[#0F172A]">Design</h4>
                <p className="text-[#64748B] text-sm font-medium">Intuitive interfaces.</p>
              </motion.div>
            </motion.div>
          </div>
        </section>
        ...
        <section id="contact" className="min-h-screen flex flex-col items-center justify-center bg-[#F1F5F9] border-t border-border/20 py-20">
          <div className="w-full max-w-[1100px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            <div className="lg:col-span-5 flex flex-col gap-8">
              ...
              <div className="flex flex-col gap-4">
                <a href="mailto:hello@tminus0.agency" className="text-xl font-bold text-accent hover:text-accent-hover transition-colors">hello@tminus0.agency</a>
