  ...
  return (
    <div className="min-h-screen bg-bg text-text-primary flex items-center justify-center px-6">
      <div className="max-w-[520px] w-full text-center flex flex-col items-center gap-6">
        ...
        <Link
          href="/"
          className="pressable group inline-flex items-center gap-2 bg-accent text-white px-8 py-4 rounded-full font-mono text-sm tracking-[0.12em] uppercase transition-[background-color,box-shadow] duration-200 hover:bg-accent-dark hover:shadow-[0_10px_28px_-10px_rgba(0,147,214,0.55)]"
        >
