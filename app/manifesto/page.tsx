    ...
    <div className="min-h-screen bg-[#F8FAFC] text-[#0F172A] selection:bg-[#DCFCE7] selection:text-[#16A34A] overflow-x-hidden">
      <main className="relative min-h-screen pt-16 md:pt-20">
        ...
        <div className="fixed inset-0 pointer-events-none z-0 opacity-20"
          style={{ backgroundImage: 'linear-gradient(to right, rgba(22,163,74,0.05) 1px, transparent 1px)', backgroundSize: '8.333333% 100%' }}>
        </div>
        ...
        <header className="relative min-h-[60vh] md:h-[80vh] w-full flex flex-col justify-center items-center text-center px-4 sm:px-6 overflow-hidden py-16 md:py-0">
          ...
          <div className="relative z-10 max-w-5xl w-full px-4">
            <p className="text-[#16A34A] uppercase tracking-widest mb-6 text-xs sm:text-sm font-semibold">
            ...
            <h1 className="text-[clamp(3.5rem,14vw,12rem)] font-bold leading-[0.9] tracking-tight mb-4 text-[#0F172A]">
              The<br />Manifesto
            </h1>
            <div className="w-16 sm:w-24 h-1 bg-[#16A34A] mx-auto mt-8 sm:mt-12 rounded-full"></div>
          </div>
        </header>
          ...
          <div className="flex flex-col gap-16 sm:gap-24 md:gap-32">
            ...
            <section className="flex flex-col sm:flex-row gap-4 sm:gap-6 items-start">
              <div className="shrink-0">
                <span className="text-5xl sm:text-7xl md:text-8xl font-bold text-[#16A34A]/80 leading-none">01</span>
              </div>
              <div className="border-l-2 border-[#E2E8F0] pl-5 sm:pl-8 md:pl-10 pt-2">
                <h2 className="text-[clamp(1.6rem,4vw,3.5rem)] font-bold tracking-tight mb-4 leading-tight text-[#0F172A]">No Templates. No &ldquo;Someday&rdquo; Projects.</h2>
                <p className="text-base sm:text-lg md:text-xl text-[#64748B] font-medium leading-relaxed max-w-3xl">
            ...
            <section className="flex flex-col sm:flex-row gap-4 sm:gap-6 items-start">
              <div className="shrink-0">
                <span className="text-5xl sm:text-7xl md:text-8xl font-bold text-[#16A34A]/80 leading-none">02</span>
              </div>
              <div className="border-l-2 border-[#E2E8F0] pl-5 sm:pl-8 md:pl-10 pt-2">
                <h2 className="text-[clamp(1.6rem,4vw,3.5rem)] font-bold tracking-tight mb-4 leading-tight text-[#0F172A]">Function Dictates Form.</h2>
                <p className="text-base sm:text-lg md:text-xl text-[#64748B] font-medium leading-relaxed max-w-3xl">
            ...
            <section className="flex flex-col sm:flex-row gap-4 sm:gap-6 items-start">
              <div className="shrink-0">
                <span className="text-5xl sm:text-7xl md:text-8xl font-bold text-[#16A34A]/80 leading-none">03</span>
              </div>
              <div className="border-l-2 border-[#E2E8F0] pl-5 sm:pl-8 md:pl-10 pt-2">
                <h2 className="text-[clamp(1.6rem,4vw,3.5rem)] font-bold tracking-tight mb-4 leading-tight text-[#0F172A]">Mediocrity is a Disease.</h2>
                <p className="text-base sm:text-lg md:text-xl text-[#64748B] font-medium leading-relaxed max-w-3xl">
            ...
            <section className="flex flex-col sm:flex-row gap-4 sm:gap-6 items-start">
              <div className="shrink-0">
                <span className="text-5xl sm:text-7xl md:text-8xl font-bold text-[#16A34A]/80 leading-none">04</span>
              </div>
              <div className="border-l-2 border-[#E2E8F0] pl-5 sm:pl-8 md:pl-10 pt-2">
                <h2 className="text-[clamp(1.6rem,4vw,3.5rem)] font-bold tracking-tight mb-4 leading-tight text-[#0F172A]">Speed is a Feature.</h2>
                <p className="text-base sm:text-lg md:text-xl text-[#64748B] font-medium leading-relaxed max-w-3xl">
            ...
            <section className="flex flex-col sm:flex-row gap-4 sm:gap-6 items-start">
              <div className="shrink-0">
                <span className="text-5xl sm:text-7xl md:text-8xl font-bold text-[#16A34A]/80 leading-none">05</span>
              </div>
              <div className="border-l-2 border-[#E2E8F0] pl-5 sm:pl-8 md:pl-10 pt-2">
                <h2 className="text-[clamp(1.6rem,4vw,3.5rem)] font-bold tracking-tight mb-4 leading-tight text-[#0F172A]">If It Doesn&apos;t Wake You Up, It&apos;s Not Ready.</h2>
                <p className="text-base sm:text-lg md:text-xl text-[#64748B] font-medium leading-relaxed max-w-3xl">
